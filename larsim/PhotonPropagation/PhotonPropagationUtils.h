 ...
 */
/*   double         SRTime;                        // PureLAr: rising time of
 * slow LAr scinitllation; */
/*   double         SDTime;                        // PureLAr: decay time of
 * slow LAr scintillation; */
/*   double         FRTime;                        // PureLAr: rising time of
 * fast LAr scinitllation; */
/*   double         FDTime;                        // PureLAr: decay time of
 * fast LAr scintillation; */
...
double interpolate(const std::vector<double> &xData,
                   const std::vector<double> &yData, double x, bool extrapolate,
                   size_t i = 0);
double
interpolate2(const std::vector<double> &xDistances,
             const std::vector<double> &rDistances,
             const std::vector<std::vector<std::vector<double>>> &parameters,
             const double x, const double r, const size_t k);
