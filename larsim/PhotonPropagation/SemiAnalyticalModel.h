...
public:
  // constructor
  SemiAnalyticalModel(fhicl::ParameterSet VUVHits, fhicl::ParameterSet VISHits,
  ...
  void
  detectedReflectedVisibilities(std::vector<double> &ReflDetectedVisibilities,
...
private:
  ...
  double VUVVisibility(geo::Point_t const &ScintPoint,
